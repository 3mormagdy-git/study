            ...
            {(formik) => {
                ...
                return (
                    ...
                    <div className="  bg-[#122740] w-full  h-screen bg-cover flex justify-center items-center flex-col   text-[#DCEAF7]   ">
                        ...
                        <form onSubmit={handleSubmit} className=" flexbox  justify-center flex-col text-[#DCEAF7] items-center border-4 border-opacity-15 border-solid border-[#4A74A7] w-96 h-72 bg-[#ffffff51]  rounded-xl  px-7 pt-14 "  >
                            <div className="form-row flex flex-col font-bold rounded-2xl  " >
                                <label htmlFor="email">Email</label>
                                <input type="email" name="email" id="email" values={values.email} onChange={handleChange} onBlur={handleBlur}

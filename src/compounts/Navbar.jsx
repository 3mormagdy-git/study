        ...
        <>
            <nav className=" flex flex-row  gap-6 justify-center relative h-16 bg-gray-600/25"   >
                ...
                <div className="flex flex-row  gap-5 items-end absolute right-7 ">
                    <button className=" bg-gray-200/50 w-28 h-10 rounded-xl my-3 hover:bg-cyan-300/55    "    >Sign in</button>
                    <button className=" bg-gray-200/50 w-28 h-10 rounded-xl my-3  hover:bg-cyan-300/55         "   >Sign up</button>
                </div>
            </nav>
